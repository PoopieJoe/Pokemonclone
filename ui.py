...
def drawMoveselect(surface,beast):
    ...
    statusfont = pygame.font.SysFont(None,int(400*buttonheight))
    elements = [[]]
    col_num = 0
    ...
    statustext = [beast.name,"Healthy"]
    statusbox = TextBox(Box(Rect_f(0,0,0,0),None),statustext,font=statusfont,textcolor=pygame.Color("black"),backgroundcolor=MOVESELECTFOREGROUNDCOLOR)
